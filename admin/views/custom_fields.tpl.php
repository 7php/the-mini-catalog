<div class="margin:10px 10px;">
    ...
    <div data-name="<?php echo esc_attr($this->field_list['tmc_price']['name']) ?>" data-type="number" data-key="<?php echo esc_attr($this->field_list['tmc_price']['name']) ?>">
        <div class="label">
            <label for="<?php echo esc_attr($this->field_list['tmc_price']['name']) ?>" style="font-weight: bold; font-size: large; padding:20px 5px 5px 5px; color: #0A246A;"><?php echo esc_attr($this->field_list['tmc_price']['label']) ?>:</label></div>
        <div class="input">
    ...
    <div data-name="<?php echo esc_attr($this->field_list['tmc_display_price']['name']) ?>" data-type="true_false" data-key="field_5e201f46223c6">
        <div class="label">
            <label for="<?php echo esc_attr($this->field_list['tmc_display_price']['name']) ?>" style="font-weight: bold; font-size: large; padding:20px 5px 5px 5px; color: #0A246A;"><?php echo esc_attr($this->field_list['tmc_display_price']['label']) ?>:</label></div>
        <div class="input">
    ...
    <div data-name="<?php echo esc_attr($this->field_list['tmc_quantity']['name']) ?>" data-type="number" data-key="<?php echo esc_attr($this->field_list['tmc_quantity']['name']) ?>">
        <div class="label">
            <label for="<?php echo esc_attr($this->field_list['tmc_quantity']['name']) ?>"style="font-weight: bold; font-size: large; padding:20px 5px 5px 5px; color: #0A246A;" ><?php echo esc_attr($this->field_list['tmc_quantity']['label']) ?>:</label></div>
        <div class="input">
            <div class="input-wrap">
    ...
    <div data-name="<?php echo esc_attr($this->field_list['tmc_display_quantity']['name']) ?>" data-type="true_false" data-key="<?php echo esc_attr($this->field_list['tmc_display_quantity']['name']) ?>">
        <div class="label">
            <label for="<?php echo esc_attr($this->field_list['tmc_display_quantity']['name']) ?>" style="font-weight: bold; font-size: large; padding:20px 5px 5px 5px; color: #0A246A;"><?php echo esc_attr($this->field_list['tmc_display_quantity']['label']) ?>:</label></div>
        <div class="input">
            <div class="true-false">
    ...
    <div data-name="<?php echo esc_attr($this->field_list['tmc_stock']['name']) ?>" data-type="number" data-key="<?php echo esc_attr($this->field_list['tmc_stock']['name']) ?>">
        <div class="label">
            <label for="<?php echo esc_attr($this->field_list['tmc_stock']['name']) ?>" style="font-weight: bold; font-size: large; padding:20px 5px 5px 5px; color: #0A246A;"><?php echo esc_attr($this->field_list['tmc_stock']['label']) ?>:</label></div>
        <div class="input">
            <div class="input-wrap">
    ...
    <div data-name="<?php echo esc_attr($this->field_list['tmc_promotional_price']['name']) ?>" data-type="number" data-key="<?php echo esc_attr($this->field_list['tmc_promotional_price']['name']) ?>a">
        <div class="label">
            <label for="<?php echo esc_attr($this->field_list['tmc_promotional_price']['name']) ?>" style="font-weight: bold; font-size: large; padding:20px 5px 5px 5px; color: #0A246A;"><?php echo esc_attr($this->field_list['tmc_promotional_price']['label']) ?>:</label></div>
        <div class="input">
            <div class="input-wrap">
    ...
    <div data-name="<?php echo esc_attr($this->field_list['tmc_display_promo']['name']) ?>" data-type="true_false" data-key="<?php echo esc_attr($this->field_list['tmc_display_promo']['name']) ?>">
        <div class="label">
            <label for="<?php echo esc_attr($this->field_list['tmc_display_promo']['name']) ?>" style="font-weight: bold; font-size: large; padding:20px 5px 5px 5px; color: #0A246A;"><?php echo esc_attr($this->field_list['tmc_display_promo']['label']) ?>:</label></div>
        <div class="input">
            <div class="true-false">
    ...
    <div data-name="<?php echo esc_attr($this->field_list['tmc_display_date']['name']) ?>" data-type="true_false" data-key="<?php echo esc_attr($this->field_list['tmc_display_date']['name']) ?>">
        <div class="label">
            <label for="<?php echo esc_attr($this->field_list['tmc_display_date']['name']) ?>" style="font-weight: bold; font-size: large; padding:20px 5px 5px 5px; color: #0A246A;"><?php echo esc_attr($this->field_list['tmc_display_date']['label']) ?>:</label></div>
        <div class="input">
            <div class="true-false">
