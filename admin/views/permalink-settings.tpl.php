...
<table class="form-table tmc-permalink-structure">
    <tbody>
        <tr>
            <th><label><input name="product_permalink" type="radio" value="<?php echo esc_attr( $this->structures[0] ); ?>" class="wctog" <?php checked( $this->structures[0], $this->permalinks['product_base'] ); ?> /> <?php esc_html_e( 'Default', PostTypeEnum::CUSTOM_TEXT_DOMAIN ); ?></label></th>
