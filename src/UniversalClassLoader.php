<?php
/**
 * UniversalClassLoader implements a "universal" autoloader
 *
 * It is able to load classes that use either:
 *
 *  * The technical interoperability standards for namespaces and
 *    class names (https://www.php-fig.org/psr/psr-4/);
 *
 * Example usage:
 *
